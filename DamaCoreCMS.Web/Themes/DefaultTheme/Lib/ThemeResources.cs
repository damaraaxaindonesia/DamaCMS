...
namespace DefaultTheme.Lib
{
    public class ThemeResources
    {
        public static string RegisterResources(string layoutName = "")
        {
            ...
            ThemeHelper.RegisterCss(string.Concat("/Themes/DefaultTheme/css/", ThemeHelper.ActiveTheme.Settings["style"]), NccResource.IncludePosition.Header, ThemeHelper.ActiveTheme.Settings["version"].ToString());
