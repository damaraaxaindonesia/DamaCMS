...
using DamaCoreCMS.Framework.Core.Mvc.Cache;
using System.Net;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            try
            {
                ...
                DamaCoreCMSHost.Logger = loggerFactory.CreateLogger<Startup>();
                DamaCoreCMSHost.HttpContext = new HttpContextAccessor().HttpContext;

                app.UseRequestTracker();
                app.UseDamaCoreCMS(env, _serviceProvider, loggerFactory);
        ...
        private void AddLogger()
        {
            ...
            {
                var logFilePath = NccInfo.LogFolder + "\\{Date}_DamaCoreCMS_Logs.log";
