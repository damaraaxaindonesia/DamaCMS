...
{
    [AdminMenu(IsVisible = false, Name = "Manage Account (Admin)")]
    public class ManageController : NccController
    {
        ...
        [HttpGet]    
        [AllowAuthenticated]
        public async Task<IActionResult> IndexBackend()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
        ...
        [HttpPost]        
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> IndexBackend(IndexViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        [HttpGet]        
        [AllowAnonymous]
        public async Task<IActionResult> ChangePasswordBackend()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
        ...
        [HttpPost]        
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ChangePasswordBackend(ChangePasswordViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("DamaCoreCMS.Web"),
