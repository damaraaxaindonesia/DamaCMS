...
namespace Core.Admin.Controllers
{
    ...
    public class UserAuthController : NccController
    {
        ...
        public ActionResult ManageUserRoles()
        {
            ...
            {
                var moduleCount = item.PermissionDetails.GroupBy(x => x.ModuleName).Count();
        ...
        public ActionResult DeleteRoleConfirm(long roleId)
        {
            ...
            if(permission == null)
            {
                ShowMessage("Permission did not found.", DamaCoreCMS.Framework.Core.Mvc.Views.MessageType.Error, showCloseButton: true);
            }
        ...
        public ActionResult DeleteRole(NccPermission model)
        {
            ...
            ShowMessage($"Role {model.Name} delete successfull.", DamaCoreCMS.Framework.Core.Mvc.Views.MessageType.Success, showAfterRedirect:true, showCloseButton: true);
